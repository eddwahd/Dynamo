...
% Drift Hamiltonian
%H_drift = 0.5 * (kron(SX,SX) + kron(SY,SY) + kron(SZ,SZ));
H_drift = 0.5 * (kron(SX,SX) + kron(SY,SY));
%H_drift = 0.5 * SX;
...
H_ctrl = {kron(SX, I), kron(SY,I), -1 * superop_lindblad(relax2)};
